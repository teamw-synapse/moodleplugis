...
define(['local_rolemanagement/cardPaginate','jquery', 'core/str', 'core/modal_factory', 'core/modal_events', 'core/fragment', 'core/templates', 'core/ajax', 'core/yui'],
    ...
    register.prototype.init = function(args) {
        ...
        var self = this;
             var head =  Str.get_string('quiz_submissions', 'block_admindashboard');
    ...
    register.prototype.getBody = function() {
        ...
        // params.employee = this.employee; 
          ...
          return Fragment.loadFragment('block_admindashboard', 'quiz_subusers', 5,  params);  
    ...
    return /** @alias module:local_course/register */ {
        ...
        init: function(args) {
           ...
           return new register(args);
            ...
            var search = $('#quizsubsearch').val();

           
                var options = {};
                        options['targetID'] = 'manage_quiz_subusers';
                        options['perPage'] = 5;
                        ...
                        dataoptions['quizid'] = args.quizid;
                        dataoptions['search'] = search ;                          
                   
                        var filterdata = {};                           
                         
                        var context = {};
                        context['targetID'] = 'manage_quiz_subusers';
