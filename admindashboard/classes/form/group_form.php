...
use block_admindashboard\handler;
...
class group_form extends moodleform {
    ...
    // require_once($CFG->dirroot.'/blocks/admindashboard/customfield/group_handler.php');
    ...
    function definition () {
        ...
        $handler = \block_admindashboard\customfield\group_handler::create();
    ...
    public function definition_after_data() {
        ...
        if ($group = $DB->get_record('groups', array('id' => $groupid))) {
            ...
            if (\core_message\api::can_create_group_conversation($USER->id, $coursecontext)) {
                if (\core_message\api::is_conversation_area_enabled('block_admindashboard', 'groups', $groupid, $coursecontext->id)) {
